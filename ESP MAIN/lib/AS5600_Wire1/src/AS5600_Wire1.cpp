...
/****************************************************
  Method: AMS_5600_Wire1
  In: none
  Out: none
  Description: constructor class for AMS 5600
*****************************************************/
AMS_5600_Wire1::AMS_5600_Wire1()
{
...
*******************************************************/
void AMS_5600_Wire1::setOutPut(uint8_t mode)
{
...
/*******************************************************
  ...
  register.
*******************************************************/
word AMS_5600_Wire1::setMaxAngle(word newMaxAngle)
{
  word _maxAngle;
  if (newMaxAngle == -1)
...
*******************************************************/
word AMS_5600_Wire1::getMaxAngle()
{
...
/*******************************************************
  ...
  magnet.  
*******************************************************/
word AMS_5600_Wire1::setStartPosition(word startAngle)
{
  word _rawStartAngle;
  if (startAngle == -1)
...
*******************************************************/
word AMS_5600_Wire1::getStartPosition()
{
...
/*******************************************************
  ...
  magnet.  
*******************************************************/
word AMS_5600_Wire1::setEndPosition(word endAngle)
{
  word _rawEndAngle;
  if (endAngle == -1)
...
*******************************************************/
word AMS_5600_Wire1::getEndPosition()
{
...
*******************************************************/
word AMS_5600_Wire1::getRawAngle()
{
...
/*******************************************************
  ...
  determine value
*******************************************************/
word AMS_5600_Wire1::getScaledAngle()
{
...
/*******************************************************
  ...
  MD bit.
*******************************************************/
int AMS_5600_Wire1::detectMagnet()
{
...
/*******************************************************
  ...
  MH,ML,MD bits.
*******************************************************/
int AMS_5600_Wire1::getMagnetStrength()
{
...
*******************************************************/
word AMS_5600_Wire1::getMagnitude()
{
...
*******************************************************/
void AMS_5600_Wire1::setConf(word _conf)
{
...
*******************************************************/
int AMS_5600_Wire1::getBurnCount()
{
...
*******************************************************/
int AMS_5600_Wire1::burnMaxAngleAndConfig()
{
  word _maxAngle = getMaxAngle();
...
*******************************************************/
int AMS_5600_Wire1::readOneByte(int in_adr)
{
  int retVal = -1;
...
*******************************************************/
word AMS_5600_Wire1::readTwoBytesTogether(int addr_in)
{
...
/*******************************************************
  ...
  Description: reads two bytes register from i2c
*******************************************************/
word AMS_5600_Wire1::readTwoBytesSeparately(int addr_in)
{
...
*******************************************************/
void AMS_5600_Wire1::writeOneByte(int adr_in, int dat_in)
{
  Wire1.beginTransmission(_ams5600_Address);
  Wire1.write(adr_in);
  Wire1.write(dat_in);
