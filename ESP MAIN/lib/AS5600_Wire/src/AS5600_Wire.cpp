...
/****************************************************
  Method: AMS_5600_Wire
  In: none
  Out: none
  Description: constructor class for AMS 5600
*****************************************************/
AMS_5600_Wire::AMS_5600_Wire()
{
...
*******************************************************/
void AMS_5600_Wire::setOutPut(uint8_t mode)
{
...
/*******************************************************
  ...
  register.
*******************************************************/
word AMS_5600_Wire::setMaxAngle(word newMaxAngle)
{
  word _maxAngle;
  if (newMaxAngle == -1)
...
*******************************************************/
word AMS_5600_Wire::getMaxAngle()
{
...
/*******************************************************
  ...
  magnet.  
*******************************************************/
word AMS_5600_Wire::setStartPosition(word startAngle)
{
  word _rawStartAngle;
  if (startAngle == -1)
...
*******************************************************/
word AMS_5600_Wire::getStartPosition()
{
...
/*******************************************************
  ...
  magnet.  
*******************************************************/
word AMS_5600_Wire::setEndPosition(word endAngle)
{
  word _rawEndAngle;
  if (endAngle == -1)
...
*******************************************************/
word AMS_5600_Wire::getEndPosition()
{
...
*******************************************************/
word AMS_5600_Wire::getRawAngle()
{
...
/*******************************************************
  ...
  determine value
*******************************************************/
word AMS_5600_Wire::getScaledAngle()
{
...
/*******************************************************
  ...
  MD bit.
*******************************************************/
int AMS_5600_Wire::detectMagnet()
{
...
/*******************************************************
  ...
  MH,ML,MD bits.
*******************************************************/
int AMS_5600_Wire::getMagnetStrength()
{
...
*******************************************************/
word AMS_5600_Wire::getMagnitude()
{
...
*******************************************************/
void AMS_5600_Wire::setConf(word _conf)
{
...
*******************************************************/
int AMS_5600_Wire::getBurnCount()
{
...
*******************************************************/
int AMS_5600_Wire::burnMaxAngleAndConfig()
{
  word _maxAngle = getMaxAngle();
...
*******************************************************/
int AMS_5600_Wire::readOneByte(int in_adr)
{
  int retVal = -1;
...
*******************************************************/
word AMS_5600_Wire::readTwoBytesTogether(int addr_in)
{
...
/*******************************************************
  ...
  Description: reads two bytes register from i2c
*******************************************************/
word AMS_5600_Wire::readTwoBytesSeparately(int addr_in)
{
...
*******************************************************/
void AMS_5600_Wire::writeOneByte(int adr_in, int dat_in)
{
  Wire.beginTransmission(_ams5600_Address);
  Wire.write(adr_in);
  Wire.write(dat_in);
